...
export declare const LineChart: typeof _LineChart & {
    ...
    VerticalLine: typeof LineChartVerticalLine;
    Tooltip: typeof LineChartTooltip;
    Provider: typeof LineChartProvider;
    PriceText: typeof LineChartPriceText;
    XDateAxis: ({ viewStyle, textStyle, tickNum, locale, options, }: {
        viewStyle?: import("react-native").ViewStyle | undefined;
        textStyle: import("react-native").TextStyle;
        tickNum: number;
        locale?: string | undefined;
        options?: Intl.DateTimeFormatOptions | undefined;
    }) => JSX.Element;
    LossRecolor: typeof LossRecolor;
